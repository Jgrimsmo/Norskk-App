...
export const projects: Project[] = [
  {
    ...
    number: "2026-001",
    developerId: "Apex Development Group",
  ...
  },
  {
    ...
    number: "2026-003",
    developerId: "Northern Logistics Inc.",
...
export const sampleDailyReports: DailyReport[] = [
  {
    ...
    endOfDayPhotoUrls: [],
    photoUrls: [],
    workDescription: "Continued foundation work Section B. Steel erection 3rd floor. MEP rough-in 2nd floor.",
    onSiteStaff: ["emp-1", "emp-2", "emp-3"],
    tmWork: false,
    tmWorkDescription: "",
    tmDailyRentals: "",
    authorSignature: "",
  ...
  },
  {
    ...
    endOfDayPhotoUrls: [],
    photoUrls: [],
    workDescription: "Concrete pour Section B foundations — 120 CY placed. Weather caused delays.",
    onSiteStaff: ["emp-1", "emp-4"],
    tmWork: true,
    tmWorkDescription: "Additional dewatering due to rain — 3 hours pump operation",
    tmDailyRentals: "Submersible pump rental from United Rentals",
    authorSignature: "",
    approverSignature: "",
    approverId: "",
  ...
  },
  {
    ...
    endOfDayPhotoUrls: [],
    photoUrls: [],
    workDescription: "Interior framing 3rd floor units 3A–3D. Exterior sheathing 4th floor.",
    onSiteStaff: ["emp-3", "emp-5"],
    tmWork: false,
    tmWorkDescription: "",
    tmDailyRentals: "",
    authorSignature: "",
